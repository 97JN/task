...
INSERT INTO lecture(id, lecture_name, person_limit, person_entries_left, conference_id)VALUES (1,'Lecture 1',5,5,1);
INSERT INTO lecture(id, lecture_name, person_limit, person_entries_left, conference_id)VALUES (2,'Lecture 2',5,5,1);
...
INSERT INTO lecture(id, lecture_name, person_limit, person_entries_left, conference_id)VALUES (5,'Lecture 5',5,5,2);
INSERT INTO lecture(id, lecture_name, person_limit, person_entries_left, conference_id)VALUES (6,'Lecture 6',5,5,2);
INSERT INTO lecture(id, lecture_name, person_limit, person_entries_left, conference_id)VALUES (7,'Lecture 7',5,5,3);
INSERT INTO lecture(id, lecture_name, person_limit, person_entries_left, conference_id)VALUES (8,'Lecture 8',5,5,3);
INSERT INTO lecture(id, lecture_name, person_limit, person_entries_left, conference_id)VALUES (9,'Lecture 9',5,5,3);



--JEZELI CHCEMY PRZETESTOWAC METODY GET NALEŻY ODKOMENTOWAĆ TE INSETRY A ZAKOMENTOWAĆ POWYŻSZY (INSERT INTO lecture..)
--IF WE WANT TO TEST OUR GET METHODS WE NEED TO UNCOMMENT BELOW INSERTS AND COMMENT INTSERTS ABOVE (INSERT INTO lectures..)
